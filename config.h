...
static const float bordercolor[]           = {0.2, 0.2, 0.2, 1.0};
/* static const float focuscolor[]            = {0.84, 0.09, 0.37, 1.0}; */
...
static const char *const autostart[] = {
        "wbg", "/home/sergio/pix/system-wallpaper", NULL,
        "someblocks", "&", NULL,
        "mako", "&", NULL,
        NULL /* terminate */
};
...
static const char *menucmd[] = { "bemenu-run", "-H", "18", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                    XKB_KEY_u,          spawn,          SHCMD("menuopenuni") },
	{ MODKEY,                    XKB_KEY_g,          spawn,          SHCMD("repo") },
